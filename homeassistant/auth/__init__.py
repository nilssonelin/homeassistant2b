...
class AuthManager:
    ...
    async def async_create_refresh_token(
        ...
        self._validate_user(user, client_id, token_type, client_name)
        expire_at = self._calculate_expiration(token_type)
        self._check_long_lived_token_conflict(user, token_type, client_name)
    ...
    def _validate_user(
        ...
        """Validate the user and related token constraints."""
    ...
    def _determine_token_type(self, user: models.User, token_type: str | None) -> str:
        """Determine the appropriate token type if not provided."""
    ...
    def _check_long_lived_token_conflict(
        self, user: models.User, token_type: str, client_name: str | None
    ) -> None:
        """Check for conflicts with long-lived access tokens."""
